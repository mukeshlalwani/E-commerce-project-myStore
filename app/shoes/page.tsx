...
export default function ShoesPage() {
    ...
    return (
        <main>
            ...
            {/* ================= FILTER BAR ================= */}
            <section className="bg-white/80 dark:bg-black/80 backdrop-blur border-b">
                <div className="max-w-7xl mx-auto px-4 py-6 space-y-5">
                  ...
                  ${activeType === type
                                        ? "bg-black text-white dark:bg-white dark:text-black scale-[1.05]"
                                        : "bg-orange-100 text-orange-700 dark:bg-gray-800 dark:text-gray-300 hover:scale-[1.03]"
                                    }
                `}
                            >
                                {type}
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <select
                                ...
                                className="px-4 py-2 rounded-full text-sm bg-gray-100 dark:bg-gray-800 border border-black/10 dark:border-white/10 focus:outline-none"
                            >
            ...
            {/* ================= SANDALS SECTION ================= */}
            <section className="py-20 px-6 bg-gradient-to-br from-yellow-50 to-orange-100 dark:from-gray-900 dark:to-black">
                <div className="max-w-7xl mx-auto">
                    ...
                    {products.filter(p => p.category === "sandals").length === 0 && (
                        <p className="text-center text-gray-400 mt-16">
            ...
            <section className="pb-24 text-center">
                <Link
                    href="/cart"
                    className="inline-block px-14 py-6 rounded-full bg-gradient-to-r from-orange-600 to-red-600 text-white text-xl font-semibold"
                >
                    Order Now 👟
                </Link>
            </section>
